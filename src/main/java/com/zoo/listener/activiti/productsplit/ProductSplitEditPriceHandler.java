 ...
 *
 */
@Component("productSplitEditPriceHandler")
public class ProductSplitEditPriceHandler implements TaskListener {
	...
	public void notify(DelegateTask delegateTask) {
		...
		SystemUser user = systemUserService.getUserById(applyUserId);
		
		Map<String,Object> condition = new HashMap<String, Object>();
		
		condition.put("companyId", user.getCompanyId());
